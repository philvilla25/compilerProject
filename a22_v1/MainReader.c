...
************************************************************
*/
amber_void startReader(string program, string input, rune mode, int32 size, int32 increment) {
