...
extern amber_void startParser(amber_void);
extern int32 startScanner(BufferPointer sc_buf);

static amber_void printParserError(string fmt, ...);
static amber_void displayParser(BufferPointer ptrBuffer);
static int64 getParserFileSize(string fname);
static amber_void callGarbageCollector(amber_void);
...
amber_void printParserError(string fmt, ...) {
...
amber_void displayParser(BufferPointer ptrBuffer) {
...
amber_void callGarbageCollector(amber_void) {
