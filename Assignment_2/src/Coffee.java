...
public class Coffee extends FoodItem {
	...
	@Override
	/**
	 * Description: Override from super class addItem method
	 * {@inheritDoc}
	 * @param Scanner, boolean from file
	 * @return boolean 
	 */
		...
		do {
			...
			if (fromFile == false) {
				...
				try {
					...
					System.out.print("Enter the name of the Coffee Farm: ");
	...
	public String toString() {
		...
		return super.toString() + " Coffee Farm: " + farm; // calls super class FoodItem tostring method to print
	...
	void outPutItem(Formatter writer) {
		...
		writer.format("Item Code: %s %s %d price $%.2f cost $%.2f Coffee Farm: %s",
